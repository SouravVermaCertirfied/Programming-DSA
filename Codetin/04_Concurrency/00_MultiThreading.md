...
- <span style="color:green;"><strong> 🧠 Use structures if more than one arguments have to be passed, as create thread accepts only one argument </strong></span>.  
    **Example**
    ```c
...
## Simple `pthread`
Create two threads using different functions, pass structure as thread argument.
```c
#include<pthread.h>
#include<stdio.h>
