...
## 3. `restrict`
Using this keyword the developer tells the compiler that : 
>**“During this pointer’s lifetime, the object it points to will only be accessed through this pointer (and not through any other pointer).”**
