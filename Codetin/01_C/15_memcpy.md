...
### Shallow Copy
- Copies only variable values
- Pointer members copy the **memory address**, not the actual data
- Both the original and copied variables point to the same memory location
- Changes made through one affect the other
- Can lead to issues such as double free or dangling pointers
- Faster and uses less memory

### Deep Copy
- Copies variable values **and** dynamically allocated data
...
- Safer when working with dynamic memory
- Requires more memory and careful implementation

### Conclusion
- Use **shallow copy** for simple data without pointers
- Use **deep copy** when structures contain dynamically allocated memory
